...
# PY3KPORT: Defining separate grammar for Python2 and 3
grammarSource3 = r"""
...
ipv4Address = <anything{4}>:packed -> socket.inet_ntop(socket.AF_INET, packed.encode('latin-1'))
ipv6Address = <anything{16}>:packed -> socket.inet_ntop(socket.AF_INET6, packed.encode('latin-1'))
...
if six.PY3:
    grammarSource = grammarSource3
else:
    grammarSource = grammarSource2
